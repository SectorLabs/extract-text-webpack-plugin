...
const NS = _path2.default.dirname(_fs2.default.realpathSync(__filename)); /* eslint-disable
                                                                            consistent-return,
                                                                            no-param-reassign
                                                                          */
...
function pitch(request) {
  ...
  query.id = (0, _helpers.ensureNumber)(query.id);
  query.omit = (0, _helpers.ensureNumber)(query.omit);
